          ...
          <el-form-item class="input" label="专业" prop="zhuanye">
              <el-input v-model="ruleForm.zhuanye" 
                placeholder="专业" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所获奖项" prop="suohuojiangxiang">
          <el-input v-model="ruleForm.suohuojiangxiang" 
              placeholder="所获奖项" clearable  :readonly="ro.suohuojiangxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所获奖项" prop="suohuojiangxiang">
              <el-input v-model="ruleForm.suohuojiangxiang" 
                placeholder="所获奖项" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所获技能" prop="suohuojineng">
          <el-input v-model="ruleForm.suohuojineng" 
              placeholder="所获技能" clearable  :readonly="ro.suohuojineng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所获技能" prop="suohuojineng">
              <el-input v-model="ruleForm.suohuojineng" 
                placeholder="所获技能" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学校经历" prop="xuexiaojingli">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="学校经历"
                  v-model="ruleForm.xuexiaojingli" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuexiaojingli" label="学校经历" prop="xuexiaojingli">
                    <span>{{ruleForm.xuexiaojingli}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="社会实践" prop="shehuishijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shehuishijian" label="社会实践" prop="shehuishijian">
                    <span>{{ruleForm.shehuishijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.suohuojineng = true;
            continue;
	            	            ...
	            	            if(o=='xuexiaojingli'){
            this.ruleForm.xuexiaojingli = obj[o];
	    this.ro.xuexiaojingli = true;
            continue;
          }
	            	            if(o=='shehuishijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xueshengjianli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueshengjianliCrossAddOrUpdateFlag = false;
                  this.parent.search();
