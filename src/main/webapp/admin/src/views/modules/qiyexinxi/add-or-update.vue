        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="员工人数" prop="yuangongrenshu">
          <el-select v-model="ruleForm.yuangongrenshu" placeholder="请选择员工人数">
            <el-option
                v-for="(item,index) in yuangongrenshuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                          ...
                                                          this.yuangongrenshuOptions = "20人以下,20-150人,150-500人,500人以上".split(',')
                                                                                                    },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
	...
	this.ruleForm.qiyejieshao = this.ruleForm.qiyejieshao.replace(reg,'../../../ssmzh48x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
