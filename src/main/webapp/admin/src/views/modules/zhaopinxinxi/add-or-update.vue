  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="工作时间" prop="gongzuoshijian">
              <el-input v-model="ruleForm.gongzuoshijian" 
                placeholder="工作时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="岗位工资" prop="gangweigongzi">
          <el-input v-model="ruleForm.gangweigongzi" 
              placeholder="岗位工资" clearable  :readonly="ro.gangweigongzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="岗位工资" prop="gangweigongzi">
              <el-input v-model="ruleForm.gangweigongzi" 
                placeholder="岗位工资" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="结算方式" prop="jiesuanfangshi">
          <el-select v-model="ruleForm.jiesuanfangshi" placeholder="请选择结算方式">
            <el-option
                v-for="(item,index) in jiesuanfangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="结算方式" prop="jiesuanfangshi">
	      <el-input v-model="ruleForm.jiesuanfangshi"
                placeholder="结算方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongzuoshijian = true;
            continue;
	            	            ...
	            	            if(o=='gangweigongzi'){
            this.ruleForm.gangweigongzi = obj[o];
	    this.ro.gangweigongzi = true;
            continue;
          }
	            	            if(o=='jiesuanfangshi'){
            this.ruleForm.jiesuanfangshi = obj[o];
	    this.ro.jiesuanfangshi = true;
            continue;
          }
	            	            if(o=='clicktime'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                  this.jiesuanfangshiOptions = "日结,周结,月结".split(',')
                                                                },
                                                                                                                                // 多级联动参数
                                                                                                                                                                  info(id) {
      this.$http({
